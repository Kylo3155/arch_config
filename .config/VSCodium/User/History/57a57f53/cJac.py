...
def iniciar_descargador():
    ...
    if category == "hetero":
        url_busqueda = f"https://www.xnxx.com/search/{keyword}/{num_pag-1}"
    else:
        url_busqueda = f"https://www.xnxx.com/search/{category}/{keyword}/{num_pag-1}"
    ...
    try:
        ...
        while descargados < num_videos and urls_completas:
            ...
            comando = [
                ...
                '-o', f'/home/kylo/videosPorno/{category}/{keyword}/{descargados+1} - %(title)s.%(ext)s', # Organizado por carpetas
                url_final
            ]
        ...
        enviar_notificacion(f"✨ Proceso {keyword} {category} finalizado.", f"Total descargado: {descargados} videos.")
